...
اگر فقط یک عنوان خاص (مثلاً اسم نرم‌افزار) را می‌خواهی وسط‌چین کنی و نمی‌خواهی از کد بالا استفاده کنی، هر جا که نوشتی `st.title("⚡️ElectroCalc M&F")` را پاک کن و این را بنویس:
